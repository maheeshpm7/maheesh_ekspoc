...
resource "aws_iam_role" "cloud-native" {
  name = "eks-cluster-cloud-native"
...
resource "aws_iam_role_policy_attachment" "cloudnative-AmazonEKSClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.cloud-native.name
}

resource "aws_iam_role_policy_attachment" "cloudnative-AmazonEKSVPCResourceController" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSVPCResourceController"
  role       = aws_iam_role.cloud-native.name
}

resource "aws_iam_role" "cloudnative2" {
  name = "eks-node-group-cloudnative"
